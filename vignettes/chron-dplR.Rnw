...
<<e, fig=TRUE>>=
wa082.std.resid <- chron(wa082.rwi, prewhiten = TRUE)
...
lines(yrs, caps(wa082.crn[, 1], nyrs = 30), col = "red", lwd = 2)
...
lines(yrs2, caps(wa082.crn2[, 1], nyrs = 30),
      col = "red", lwd = 2)
...
\caption{The \code{wa082} chronology truncated by SSS.}
...
lines(yrs2, caps(wa082.avg, nyrs = 30),
      col = "red", lwd = 2)
...
wa082.crn.strip <- chron(wa082.rwi.strip)
