...
lines(yrs,caps(dat,nyrs=256),col=my.cols[1],lwd=3)
lines(yrs,caps(dat,nyrs=128),col=my.cols[2],lwd=2)
lines(yrs,caps(dat,nyrs=64),col=my.cols[3],lwd=2)
lines(yrs,caps(dat,nyrs=32),col=my.cols[4],lwd=2)
